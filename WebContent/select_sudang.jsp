...
<%
	...
	try{
		String sql="select a.id,a.name,to_char(b.gajok,'999,999,999'),to_char(b.jikchak,'999,999,999'),to_char(b.gunsok,'999,999,999'),to_char(b.gitasudang,'999,999,999'),to_char(gajok+jikchak+gunsok+gitasudang,'999,999,999') from info0111 a,sudang0111 b where a.id=b.id";
...
%>
	<tr>
		...
		<td align="center"><a href="update_sudang.jsp?id=<%=id %>">수정</a> / 
